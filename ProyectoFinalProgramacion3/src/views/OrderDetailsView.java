...
public class OrderDetailsView extends JPanel{
	...
	public void setTableModel(OrderDetailsTableModel model) { 
	...
	public File selectPdfFile() {
		...
		String path = Config.get("orderDetails.export.pdf", System.getProperty("orderDetails.home"));
		JFileChooser chooser = new JFileChooser(path);
		
		chooser.setSelectedFile(new File("reporte-detalles-ordenes.pdf"));
		...
		int option = chooser.showDialog(this, "Exportar PDF de detalles de ordenes");
