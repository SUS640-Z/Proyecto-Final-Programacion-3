...
public class AddressView extends JPanel {
	...
	public File selectPdfFile() {
		...
		chooser.setSelectedFile(new File("reporte-direcciones.pdf"));
		chooser.setAcceptAllFileFilterUsed(false);
		chooser.addChoosableFileFilter(new FileNameExtensionFilter("Documentos PDF", "pdf"));
		
		int option = chooser.showDialog(this, "Exportar PDF");
		if(option != JFileChooser.APPROVE_OPTION) return null;
		
		File file = chooser.getSelectedFile();
		Config.set("address.export.pdf", file.getParent());
