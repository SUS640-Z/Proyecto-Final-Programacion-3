...
public class ProductView extends JPanel{
	...
	public void setTableModel(ProductTableModel model) { 
	...
	public File selectPdfFile() {
		...
		String path = Config.get("product.export.pdf", System.getProperty("product.home"));
		JFileChooser chooser = new JFileChooser(path);
		
		chooser.setSelectedFile(new File("reporte-productos.pdf"));
		...
		int option = chooser.showDialog(this, "Exportar PDF de productos");
		...
		Config.set("product.export.pdf", file.getParent());
