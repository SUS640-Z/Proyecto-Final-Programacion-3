...
// CAMBIO: Ahora hereda de JFrame en lugar de JDialog
public class CarritoView extends JFrame {
    ...
    // CAMBIO: Constructor ajustado para JFrame (ya no requiere el parámetro parent ni la herencia super)
    public CarritoView() {
        setTitle("Saturnbucks - Carrito de Compras");
        setBounds(150, 150, 650, 560); 
        setResizable(false);
        
        // Al ser JFrame, es importante definir qué pasa al cerrar la ventana.
        // DISPOSE_ON_CLOSE cierra solo esta pestaña sin apagar toda la aplicación.
        setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        
        // Centrar en la pantalla por defecto
