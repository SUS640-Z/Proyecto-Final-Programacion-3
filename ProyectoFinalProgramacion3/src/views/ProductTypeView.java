...
public class ProductTypeView extends JPanel{
	...
	public void setTableModel(ProductTypeTableModel model) { 
	...
	public File selectPdfFile() {
		...
		String path = Config.get("productType.export.pdf", System.getProperty("productType.home"));
		JFileChooser chooser = new JFileChooser(path);
		
		chooser.setSelectedFile(new File("reporte-tipos-productos.pdf"));
		...
		int option = chooser.showDialog(this, "Exportar PDF de tipos de productos");
		...
		Config.set("productType.export.pdf", file.getParent());
